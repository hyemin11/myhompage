            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="<c:url value='index.html'/>"> <img src="<c:url value='/images/nuritec/logo.png'/>" alt="logo"> </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-center"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="<c:url value='/blog.html'/>" id="navbarDropdown_2"
                                       role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        About Us
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="<c:url value='/blog.html'/>">Greeting</a>
                                        <a class="dropdown-item" href="<c:url value='/single-blog.html'/>">History</a>
                                        <a class="dropdown-item" href="<c:url value='/blog.html'/>">Patent/Certification</a>
                                        <a class="dropdown-item" href="<c:url value='/blog.html'/>">Corporate Ideology</a>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="<c:url value='/services.html'/>">Special Purpose Power Supply</a>
                                        <a class="dropdown-item" href="<c:url value='/dep.html'/>">Multi-Function Tester</a>
                                        <a class="dropdown-item" href="<c:url value='/elements.html'/>">Multi-Function Analyzer</a>
                                        <a class="dropdown-item" href="<c:url value='/elements.html'/>">Programmable Electric Load</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="<c:url value='/blog.html'/>">Notice</a>
                                        <a class="dropdown-item" href="<c:url value='/single-blog.html'/>">Board</a>
                                        <a class="dropdown-item" href="<c:url value='/blog.html'/>">Q/A</a>
                                        <a class="dropdown-item" href="<c:url value='/blog.html'/>">Ordering/Estimate</a>
                                        <a class="dropdown-item" href="<c:url value='/blog.html'/>">Related Site</a>
                                        <a class="dropdown-item" href="<c:url value='/blog.html'/>">Sitemap</a>
                                    </div>
                                </li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-xl-5">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <h1>Technology Nuri</h1>
                            <p>For the Humanity, For the Customer satisfaction, For the Best of the best. </p>
                ...
                <div class="col-lg-7">
                    <div class="banner_img">
                        <img src="<c:url value='/images/nuritec/bizpeople.png'/>" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="about_us_text">
                        <h2>About us</h2>
                        <p>Nuritechnology Inc. has been developing and supplying Programmable Electric Power Supply • Power Source • Electric Loader based on high precision measurement technology and high precision power control technology.
                            Special purpose power supply, especially induction heating power supply and power supply for particle accelerater, is now our focus.
                            Based on these cutting edge technology fused with IT, NURI technology Inc. will lead power supply and power supply measuring instrument technology in the field of control and measurement.</p>
