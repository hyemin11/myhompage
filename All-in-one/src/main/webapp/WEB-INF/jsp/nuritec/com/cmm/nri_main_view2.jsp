...
<head>
    ...
    <link href="<c:url value='http://fonts.googleapis.com/css?family=Hind:300,400,500,600,700'/>" rel="stylesheet" type="text/css">
    <link href="<c:url value='//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css'/>" rel="stylesheet">
    <link href="<c:url value='/vendor/simple-line-icons/simple-line-icons.min.css'/>" rel="stylesheet" type="text/css"/>
    <link href="<c:url value='/vendor/bootstrap/css/bootstrap.min.css'/>" rel="stylesheet" type="text/css"/>
    <link href="<c:url value='/css/flame/animate.css'/>" rel="stylesheet">
    <link href="<c:url value='/vendor/swiper/css/swiper.min.css'/>" rel="stylesheet" type="text/css"/>
    <link href="<c:url value='/css/flame/layout.min.css'/>" rel="stylesheet" type="text/css"/>
            ...
            <div class="menu-container js_nav-item">
                ...
                <div class="logo">
                    <a class="logo-wrap" href="#body">
                        <img class="logo-img logo-img-main" src="<c:url value='/images/flame/logo.png'/>" alt="FlameOnePage Logo">
                        <img class="logo-img logo-img-active" src="<c:url value='/images/flame/logo-dark.png'/>" alt="FlameOnePage Dark Logo">
                    </a>
                </div>
            </div>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="img-responsive" src="<c:url value='images/flame/1920x1080/01.jpg'/>" alt="Slider Image">
            <div class="container">
        ...
        <div class="item">
            <img class="img-responsive" src="<c:url value='images/flame/1920x1080/02.jpg'/>" alt="Slider Image">
            <div class="container">
                <div class="carousel-centered">
                    <div class="margin-b-40">
    ...
    <div class="content-lg container">
        ...
        <div class="masonry-grid row">
            ...
            <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 sm-margin-b-30">
                ...
                <img class="full-width img-responsive wow fadeInUp" src="<c:url value='images/flame/500x500/01.jpg'/>" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".2s">
            </div>
            <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                ...
                <img class="full-width img-responsive wow fadeInUp" src="<c:url value='images/flame/500x500/02.jpg'/>" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".3s">
            </div>
            <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                ...
                <img class="full-width img-responsive wow fadeInUp" src="<c:url value='images/flame/500x500/03.jpg'/>" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".4s">
            </div>
        </div>
        <!-- End Masonry Grid -->
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class="margin-b-20">
                    <img class="img-responsive" src="<c:url value='images/flame/970x647/01.jpg'/>" alt="Latest Products Image">
                </div>
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class="margin-b-20">
                    <img class="img-responsive" src="<c:url value='images/flame/970x647/02.jpg'/>" alt="Latest Products Image">
                </div>
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class="margin-b-20">
                    <img class="img-responsive" src="<c:url value='images/flame/970x647/03.jpg'/>" alt="Latest Products Image">
                </div>
